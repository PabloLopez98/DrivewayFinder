...
class MyRecyclerViewAdapterDriver extends RecyclerView.Adapter<MyRecyclerViewAdapterDriver.ViewHolder> {
    ...
    MyRecyclerViewAdapterDriver(Context context, ArrayList<String> data) {
